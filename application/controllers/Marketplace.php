...
class Marketplace extends BaseController
{
    ...
    public function index()
    {
        ...
        if ($keyword) {
            if ($keyword_category == "Nama Channel") {
                $qry .= " AND name LIKE '%$keyword%' ";
            } else if ($keyword_category == "Keterangan") {
                $qry .= " AND marketplace.desc LIKE '%$keyword%' ";
            }
        }
        ...
        $url = base_url() . '/marketplace/' . $this->template->get_param();
        $data['url'] = $this->template->get_param_without_keyword_category($url);
        $data['param'] = $this->template->get_param();
        $data['param_pagination'] = $this->template->get_param_without('page');
        $data['pagination'] = $this->template->pagination($data['page'], $current_page, $data['param_pagination']);

        $data['content'] = $this->load->view("marketplace/all", $data, true);
    ...
    public function item()
    {
        ...
        $query = $this->mymodel->selectWithQuery("SELECT * FROM marketplace
        WHERE $qry 
        ...
        $data['start'] = $offset;
        $this->load->view("marketplace/item", $data);
    }
    ...
    public function sync()
    {
        ...
        $this->load->view("marketplace/sync", $data);
    }
    ...
    public function item_stock()
    {
        ...
        $data['start'] = $offset;
        $this->load->view("marketplace/item_stock", $data);
    }
    ...
    public function stock()
    {
        ...
        $url = base_url() . '/marketplace/stock?id=' . $_GET['id'];

        $data['pagination'] = $this->template->pagination($data['page'], $current_page, $url);

        $data['content'] = $this->load->view("marketplace/stock", $data);
        $this->load->view("TemplateDashboard", $data);
    }
    ...
    public function edit()
    {
        ...
        $this->load->view("marketplace/edit", $data);
    }
    ...
    public function update()
    {
        ...
        if ($this->db->update('marketplace', $dt, array('id' => $id))) {
    ...
    public function create()
    {
        ...
        $this->load->view("marketplace/create", $data);
    }
    ...
    public function store()
    {
        ...
        if ($this->db->insert('marketplace', $dt)) {
    ...
    public function remove()
    {
        $id = $_GET['id'];
        $data['data']['id'] = $id;
        $this->load->view("marketplace/delete", $data);
    }
