...
<form action="<?= base_url() ?>/label/update" method="POST" id="form-modal" enctype="multipart/form-data">
	...
	<div class="col-md-12">
		<label for="">Min TRX</label>
		<input type="text" class="form-control" name="dt[min_trx]" value="<?= $data['min_trx'] ?>">
	</div>
	<div class="col-md-12">
