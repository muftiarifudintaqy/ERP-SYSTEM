...
<form action="<?= base_url() ?>/shipping/update" method="POST" id="form-modal" enctype="multipart/form-data">
	...
	<div class="col-md-12">
		...
		<?php if ($data['img']) { ?>
			<a href="<?= base_url() ?>/assets/img/shipping/<?= $data['img'] . '?token=' . DATE("Ymdhis", strtotime($data['updated_at'])) ?>" target="_blank"><i>Buka Gambar</i></a>
		<?php } ?>
