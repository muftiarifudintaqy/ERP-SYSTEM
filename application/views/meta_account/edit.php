...
<form action="<?= base_url() ?>/meta_account/update" method="POST" id="form-modal">
	<input type="hidden" name="id" value="<?= $data['id'] ?>">
	<div class="col-md-12">
		<label for="">ID Akun</label>
		<input type="text" class="form-control" name="dt[account_id]" value="<?= $data['account_id'] ?>">
	</div>
	<div class="col-md-12">
		<label for="">Nama Akun</label>
		<input type="text" class="form-control" name="dt[account_name]" value="<?= $data['account_name'] ?>">
	</div>
	<div class="col-md-12">
