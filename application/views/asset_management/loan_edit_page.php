    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0" style="color: rgba(0, 0, 0, 0.85);">Edit Peminjaman</h5>
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url() ?>/asset_management/loan_update" method="POST" id="form-edit">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="borrower_user_id" name="dt[borrower_user_id]" required>
                            ...
                            <?php foreach ($borrowers as $borrower): ?>
                                <option value="<?= $borrower['id'] ?>" <?= ($borrower['id'] == $data['borrower_user_id']) ? 'selected' : '' ?>><?= $borrower['full_name'] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="loan_date" name="dt[loan_date]" value="<?= $data['loan_date'] ?>">
                    </div>
                    <div class="col-md-6">
                        <label for="return_date" class="form-label">Tanggal Kembali</label>
                        <input type="date" class="form-control" id="return_date" name="dt[return_date]" value="<?= $data['return_date'] ?>">
                    </div>
                </div>
