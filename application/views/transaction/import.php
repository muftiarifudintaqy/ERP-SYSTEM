...
<form action="<?= base_url() ?>/transaction/import-check" method="POST" enctype="multipart/form-data" id="form-modals">
    <p class="mb-1">Silahkan upload file upload file excel!
    <br>
        <!-- <b>Manual</b><br> -->
        <a href="<?= base_url() ?>/transaction/download-template<?=$param?>&p=MANUAL" target="_blank">Download Template Manual <?=$file_name?></a>
       <!-- <br>
        <b>Marketplace</b><br>
