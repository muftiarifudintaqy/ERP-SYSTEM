    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0" style="color: rgba(0, 0, 0, 0.85);">Tambah Benefit</h5>
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url() ?>/benefit/store" method="POST" id="form-create">
                <div class="row mb-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" id="description" name="dt[description]" rows="3" 
                                  placeholder="Deskripsi detail benefit ini..." required></textarea>
                        <small class="text-muted">Jelaskan detail benefit yang akan diberikan</small>
                    </div>
                </div>
