...
<div class="fullscreen-container">
  <div class="login-container text-start">
    <div class="login-logo">
      <img src="<?= base_url() ?>/assets/img/logo.png" style="margin-top:-14px;" alt="" class="">
    </div>
...
<style>
  ...
  .login-container {
    background: linear-gradient(160deg, rgba(255,255,255,0.58) 0%, rgba(255,255,255,0.34) 100%);
    border: 1px solid rgba(255,255,255,0.65);
    border-radius: 22px;
    box-shadow: 0 22px 60px rgba(31,38,90,0.22);
  ...
  .login-container::-webkit-scrollbar-thumb { background: rgba(120,110,180,.35); border-radius: 10px; }
  ...
  .login-container .btn {
    ...
    padding: 12px;
    font-weight: 600;
    box-shadow: 0 8px 22px rgba(134,102,188,.35);
    transition: transform .15s ease, box-shadow .15s ease;
  }
  .login-container .btn:hover {
    transform: translateY(-1px);
    box-shadow: 0 12px 28px rgba(134,102,188,.45);
  }
</style>
