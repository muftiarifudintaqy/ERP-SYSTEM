...
<form action="<?= base_url() ?>/discount/update" method="POST" id="form-modal" enctype="multipart/form-data">
	...
	<div class="col-md-12">
		...
		<input type="text" class="form-control" name="dt[code]" value="<?= $data['code'] ?>">
	</div>
	<div class="col-md-12">
		<label for="">Min Nominal</label>
		<input type="text" class="form-control" name="dt[min_nominal]" value="<?= $data['min_nominal'] ?>">
	</div>
	<div class="col-md-12">
	...
	<div class="col-md-12">
		...
		<input type="text" class="form-control" name="dt[nominal]" value="<?= $data['nominal'] ?>">
	</div>
	<div class="col-md-12">
	...
	<div class="col-md-12 mt-3">
		<button type="submit" class="btn btn-primary btn-send">SAVE CHANGES</button>
	</div>
</form>
