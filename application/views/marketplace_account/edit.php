...
<form action="<?= base_url() ?>/marketplace-account/update" method="POST" id="form-modal" enctype="multipart/form-data">
	<input type="hidden" name="id" value="<?= $data['id'] ?>">
	<div class="col-md-12">
		<label for="">Nama</label>
		<input type="text" class="form-control" name="dt[shop_name]" value="<?= $data['shop_name'] ?>">
	</div>
	<div class="col-md-12">
	...
	<div class="col-md-12">
		...
		<?php if ($data['img']) { ?>
			<a href="<?= base_url() ?>/assets/img/marketplace_account/<?= $data['img'] . '?token=' . DATE("Ymdhis", strtotime($data['updated_at'])) ?>" target="_blank"><i>Buka Gambar</i></a>
		<?php } ?>
