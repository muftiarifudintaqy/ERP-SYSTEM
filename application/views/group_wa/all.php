<div class="w-100">
    <div class="row align-items-center">
        <div class="col-lg-12 mb-3">
            <h3 class="text-primary fw-600">GROUP WA</h3>
        </div>
        <div class="col-lg-12">
            <form action="">
                <div class="row">
    ...
    <div class="table-responsive" id="table-item">
                ...
                <thead>
                    <tr class="bg-blue-2 text-white">
                        ...
                        <th class="text-start">NAMA GROUP</th>
                        <th class="text-start">TGL MULAI</th>
                        <th class="text-start">TGL BERAKHIR</th>
                        <th class="text-center">J. PELANGGAN</th>
...
<script>
    function create() {
        ...
        $("#load-form").load("<?= base_url() ?>/group-wa/create");
    }
    ...
    function remove(id) {
        ...
        $("#load-form").load("<?= base_url() ?>/group-wa/remove?id=" + id);
    }
    function edit(id) {
        $("#load-form").html('Loading...');
        $("#modal-form").modal('show');
        $("#title-form").html('Edit Data');
        $("#load-form").load("<?= base_url() ?>/group-wa/edit?id=" + id);
    }
</script>
<script>
function loadMoreData() {
    $.ajax({
        type: 'GET',
        url: "<?= base_url() ?>/group-wa/item<?=$param?>",
