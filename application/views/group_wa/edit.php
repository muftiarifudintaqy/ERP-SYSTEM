...
<form action="<?= base_url() ?>/group-wa/update" method="POST" id="form-modal" enctype="multipart/form-data">
	...
	<div class="col-md-12">
		...
		<input type="date" class="form-control" name="dt[date_start]" value="<?= $data['date_start'] ?>">
	</div>
	<div class="col-md-12">
		<label for="">Tanggal Berakhir</label>
		<input type="date" class="form-control" name="dt[date_end]" value="<?= $data['date_end'] ?>">
	</div>
	<div class="col-md-12">
		<label for="">PIC</label>
