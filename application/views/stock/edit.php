...
<form action="<?= base_url() ?>/stock/update" method="POST" id="form-modal" enctype="multipart/form-data">
	...
	<div class="col-md-12 mb-2">
		<div class="form-check">
			<input class="form-check-input" type="checkbox" id="isAdjustmentEdit" name="dt[is_adjustment]" value="1" <?= isset($data['is_adjustment']) && intval($data['is_adjustment']) === 1 ? 'checked' : '' ?>>
			<label class="form-check-label" for="isAdjustmentEdit">Penyesuaian Stock</label>
		</div>
	</div>
	<div class="col-md-12">
