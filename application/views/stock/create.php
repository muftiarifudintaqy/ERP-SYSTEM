...
<form action="<?= base_url() ?>/stock/store" method="POST" id="form-modal">
	<input type="hidden" name="id" value="<?= $data['id'] ?>">
	<input type="hidden" name="dt[is_adjustment]" value="0">
	<div class="col-md-12 mb-2">
		<div class="form-check">
			<input class="form-check-input" type="checkbox" id="isAdjustmentCreate" name="dt[is_adjustment]" value="1">
			<label class="form-check-label" for="isAdjustmentCreate">Penyesuaian Stock</label>
		</div>
	</div>
	<div class="col-md-12">
