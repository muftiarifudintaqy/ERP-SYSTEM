    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0" style="color: rgba(0, 0, 0, 0.85);">Edit Quest Level</h5>
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url() ?>/quest_level/update" method="POST" id="form-edit">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" id="level_order" name="dt[level_order]" 
                               value="<?= $data['level_order'] ?>" min="1" required>
