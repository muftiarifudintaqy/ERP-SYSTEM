    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0" style="color: rgba(0, 0, 0, 0.85);">Add Interview Question</h5>
        ...
        <div class="card-body">
            <?php if (isset($_GET['success']) && $_GET['success'] == '1'): ?>
                <div class="alert alert-success">
                    <i class="bi bi-check-circle me-2"></i>Question added successfully!
                </div>
            <?php endif; ?>
            ...
            <form method="post" id="questionForm">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" 
                              ...
                              name="question_text" 
                              rows="4" 
                              placeholder="Enter the interview criteria"
                              required></textarea>
                </div>
