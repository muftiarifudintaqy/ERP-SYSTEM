...
?>
    <tbody>
        <tr class="product-row" data-product-id="<?= $v['id'] ?>">
                ...
                <div class="d-flex align-items-center">
                    <div class="me-3" style="width: 50px;">
                        <a href="<?= $v['img'] ?>" target="_blank">
                            <img src="<?= $v['img'] ?>" alt="" onerror="this.style.display='none'"
                                style="width: 40px; height: 40px; object-fit: cover; border-radius: 4px; border: 1px solid #f0f0f0;">
                        </a>
                    </div>
                    <div class="flex-grow-1">
                        <div>
                            <strong style="color: #1890ff; font-size: 14px; display: block; word-break: break-word; line-height: 1.4;"><?= $v['name'] ?></strong>
                        </div>
            ...
            <?php if (in_array($user['role'], array('1', '3', '2', '6', '12'))) { ?>
