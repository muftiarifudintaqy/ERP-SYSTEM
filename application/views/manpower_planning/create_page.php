    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0" style="color: rgba(0, 0, 0, 0.85);">Tambah Manpower Planning</h5>
        ...
        <div class="card-body">
            ...
            <form action="<?= base_url() ?>/manpower_planning/store" method="POST" id="form-create">
                <?php
                    $session_fullname = $user['full_name'] ?? '';
                    $requestor_users = $requestor_users ?? array();
                ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="requestor" name="dt[requestor]" required>
                                    ...
                                    <?php foreach ($requestor_users as $req): ?>
                                        <?php $selected = ($req['full_name'] ?? '') === $session_fullname ? 'selected' : ''; ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="posisi" name="dt[posisi]" 
                                       placeholder="e.g. Software Developer, Marketing Executive" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="level" name="dt[level]" required>
                                    ...
                                    <option value="Junior (Eksekutor)">Junior (Eksekutor)</option>
                                    <option value="Senior (Eks+Analyst)">Senior (Eks+Analyst)</option>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" id="jumlah" name="dt[jumlah]" 
                                       placeholder="Jumlah orang" value="1" min="1" required>
                            </div>
                            <div class="col-md-4">
                                <label for="sistem" class="form-label">Sistem</label>
                                <select class="form-select" id="sistem" name="dt[sistem]">
                                    <option value="">Pilih Sistem</option>
                                    <option value="Onsite Banyuwangi">Onsite Banyuwangi</option>
                                    <option value="Onsite Yogyakarta">Onsite Yogyakarta</option>
                    ...
                    <div class="section-content">
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <div id="kompetensi-editor"></div>
                                <input type="hidden" id="kompetensi_dibutuhkan" name="dt[kompetensi_dibutuhkan]">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="alasan_penambahan" name="dt[alasan_penambahan]" rows="4" 
                                          placeholder="Jelaskan alasan penambahan tenaga kerja..."></textarea>
                            </div>
                        </div>
                    </div>
                </div>
