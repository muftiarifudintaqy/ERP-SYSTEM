...
<form action="<?= base_url() ?>booking_fbs/shipping_documents_execute" method="POST" id="form-shipping-documents">
        ...
        success: function(response) {
            ...
            if (isSuccess) {
                ...
                if (response.open_print && Array.isArray(response.print_payload) && response.print_payload.length) {
                    const url = "<?= base_url('booking-fbs/print-shipping-docs-shopee') ?>";
                    ...
                    inputPdf.value = JSON.stringify(response.print_payload);
